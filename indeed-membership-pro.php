<?php
/*
Plugin Name: Pay.ir Indeed Ultimate Membership Pro
Plugin URI: http://pay.ir
Description: افزونه Ultimate Membership Pro با درگاه پرداخت Pay.ir
Author: Pay.ir team
Author URI: http://pay.ir
*/
///setting the paths
if (!defined('IHC_PATH')){
...
function ihc_initiate_plugin() {
	...
	$values = array('payment', 'payment_payir',
